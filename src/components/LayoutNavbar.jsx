  ...
  return (
    <nav
      className="fixed top-0 left-0 z-20 w-full
        border-b border-gray-200 bg-white p-2
        md:px-4"
    >
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <div className="flex md:order-2">
          <button
            type="button"
            className="mr-3 rounded-lg bg-gray-700 px-5 py-2.5 text-center text-sm font-medium text-white
            hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300  md:mr-0"
          >
            Get started
          </button>
